...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void m7d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void m8d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void m9e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void m10e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void m11i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void m12i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void m13v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void m14v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void m15w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void m16w(String str, String str2, Throwable th) {
        if (canLog(5)) {
