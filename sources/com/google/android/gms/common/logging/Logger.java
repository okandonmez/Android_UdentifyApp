...
public class Logger {
    ...
    /* renamed from: d */
    public void m17d(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: d */
    public void m18d(String str, @Nullable Object... objArr) {
        if (isLoggable(3)) {
    ...
    /* renamed from: e */
    public void m19e(String str, Throwable th, @Nullable Object... objArr) {
        Log.e(this.mTag, format(str, objArr), th);
    }

    /* renamed from: e */
    public void m20e(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: i */
    public void m21i(String str, Throwable th, @Nullable Object... objArr) {
        Log.i(this.mTag, format(str, objArr), th);
    }

    /* renamed from: i */
    public void m22i(String str, @Nullable Object... objArr) {
    ...
    /* renamed from: v */
    public void m23v(String str, Throwable th, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: v */
    public void m24v(String str, @Nullable Object... objArr) {
        if (isLoggable(2)) {
    ...
    /* renamed from: w */
    public void m25w(String str, Throwable th, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr), th);
    }

    /* renamed from: w */
    public void m26w(String str, @Nullable Object... objArr) {
        Log.w(this.mTag, format(str, objArr));
    }

    /* renamed from: w */
    public void m27w(Throwable th) {
        Log.w(this.mTag, th);
    }
