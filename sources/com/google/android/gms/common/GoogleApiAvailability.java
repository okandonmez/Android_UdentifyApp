        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0317R.drawable.common_full_open_on_phone, resources.getString(C0317R.string.common_open_on_phone), pendingIntent);
                } else {
