...
final class zzej extends zzjr {
    ...
    private static final String[] zzaex = new String[]{Param.ORIGIN, "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};
    ...
    public final boolean zza(zzee zzee) {
        ...
        contentValues.put(Param.ORIGIN, zzee.origin);
        contentValues.put("name", zzee.zzaeq.name);
        zza(contentValues, Param.VALUE, zzee.zzaeq.getValue());
    ...
    final Map<Integer, zzkt> zzbe(String str) {
        ...
        try {
            ...
            if (query.moveToFirst()) {
                Map<Integer, zzkt> arrayMap = new ArrayMap();
                do {
                    ...
                    try {
                        arrayMap.put(Integer.valueOf(i), zzkt);
                    } catch (SQLiteException e3) {
                        e = e3;
                    }
                } while (query.moveToNext());
    ...
    final Map<Integer, List<zzkg>> zzk(String str, String str2) {
        ...
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        Map<Integer, List<zzkg>> arrayMap = new ArrayMap();
        try {
    ...
    final Map<Integer, List<zzkj>> zzl(String str, String str2) {
        ...
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        Map<Integer, List<zzkj>> arrayMap = new ArrayMap();
        Cursor query;
        try {
