...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00651();
    ...
    static class C00651 implements TypeEvaluator<Matrix> {
        C00651() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C00673.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
