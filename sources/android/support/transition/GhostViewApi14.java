...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C00711();
    int mReferences;
    ...
    class C00711 implements OnPreDrawListener {
        C00711() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0075R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0075R.id.ghost_view);
    }
}
