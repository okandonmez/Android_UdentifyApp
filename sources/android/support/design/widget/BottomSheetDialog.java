...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C03442 extends AccessibilityDelegateCompat {
        C03442() {
        }
    ...
    class C03454 extends BottomSheetCallback {
        C03454() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C03454();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0012R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0012R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0012R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0012R.id.touch_outside).setOnClickListener(new C00281());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C03442());
        bottomSheet.setOnTouchListener(new C00293());
        return container;
    }
