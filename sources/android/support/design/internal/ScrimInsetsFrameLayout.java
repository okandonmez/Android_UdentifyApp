...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C03351 implements OnApplyWindowInsetsListener {
        C03351() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0012R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0012R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0012R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03351());
    }
