...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04411();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04422();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03893();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C03893 implements ViewPropertyAnimatorUpdateListener {
        C03893() {
        }
    ...
    class C04411 extends ViewPropertyAnimatorListenerAdapter {
        C04411() {
        }
    ...
    class C04422 extends ViewPropertyAnimatorListenerAdapter {
        C04422() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0238R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0238R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0238R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0238R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0238R.styleable.ActionBar, C0238R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0238R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0238R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0238R.attr.actionBarWidgetTheme, outValue, true);
