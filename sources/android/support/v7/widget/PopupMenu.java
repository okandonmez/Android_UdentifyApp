...
public class PopupMenu {
    ...
    class C02762 implements android.widget.PopupWindow.OnDismissListener {
        C02762() {
        }
    ...
    class C04041 implements Callback {
        C04041() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0238R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04041());
        ...
        this.mPopup.setOnDismissListener(new C02762());
    }
