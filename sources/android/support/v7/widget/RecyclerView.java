...
import android.support.v7.recyclerview.C0239R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02793();
    ...
    static class C02793 implements Interpolator {
        C02793() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04091();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04102();
        private int mWidth;
        ...
        class C04091 implements Callback {
            C04091() {
            }
        ...
        class C04102 implements Callback {
            C04102() {
            }
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == Integer.MIN_VALUE || parentMode == ErrorDialogData.SUPPRESSED) ? Integer.MIN_VALUE : 0;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0239R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0239R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0239R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0239R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0239R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C04064 implements ProcessCallback {
        C04064() {
        }
    ...
    class C04075 implements Callback {
        C04075() {
        }
    ...
    class C04086 implements Callback {
        C04086() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02801();
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C02801 implements ClassLoaderCreator<SavedState> {
            C02801() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02771();
        ...
        this.mItemAnimatorRunner = new C02782();
        this.mViewInfoProcessCallback = new C04064();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0239R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0239R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0239R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0239R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0239R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0239R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0239R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0239R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04075());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04086());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0239R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0239R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0239R.dimen.fastscroll_margin));
    }
