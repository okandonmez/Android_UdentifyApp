...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        if (flexibleInOtherDir) {
            ...
            for (i = 0; i < count; i++) {
                view = this.mSet[i];
                measureChild(view, ErrorDialogData.SUPPRESSED, true);
        ...
        for (i = 0; i < count; i++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    wSpec = LayoutManager.getChildMeasureSpec(totalSpaceInOther, ErrorDialogData.SUPPRESSED, horizontalInsets, lp.width, false);
                    ...
                    hSpec = LayoutManager.getChildMeasureSpec(totalSpaceInOther, ErrorDialogData.SUPPRESSED, verticalInsets, lp.height, false);
                }
