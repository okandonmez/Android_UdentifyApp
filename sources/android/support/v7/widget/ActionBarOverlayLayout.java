...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0238R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02511();
        this.mRemoveActionBarHideOffset = new C02522();
        this.mAddActionBarHideOffset = new C02533();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0238R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0238R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0238R.id.action_bar));
        }
    }
