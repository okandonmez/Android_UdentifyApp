...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02843 implements OnFocusChangeListener {
        C02843() {
        }
    ...
    class C02854 implements OnLayoutChangeListener {
        C02854() {
        }
    ...
    class C02876 implements OnKeyListener {
        C02876() {
        }
    ...
    class C02887 implements OnEditorActionListener {
        C02887() {
        }
    ...
    class C02898 implements OnItemClickListener {
        C02898() {
        }
    ...
    class C02909 implements OnItemSelectedListener {
        C02909() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02911();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C02911 implements ClassLoaderCreator<SavedState> {
            C02911() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0238R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C02921();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0238R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C02821();
        this.mReleaseCursorRunnable = new C02832();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02865();
        this.mTextKeyListener = new C02876();
        this.mOnEditorActionListener = new C02887();
        this.mOnItemClickListener = new C02898();
        this.mOnItemSelectedListener = new C02909();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0238R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0238R.styleable.SearchView_layout, C0238R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0238R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0238R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0238R.id.search_plate);
        this.mSubmitArea = findViewById(C0238R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0238R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0238R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0238R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0238R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0238R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0238R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0238R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0238R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0238R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0238R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0238R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0238R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0238R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0238R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0238R.styleable.SearchView_suggestionRowLayout, C0238R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0238R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02843());
        setIconifiedByDefault(a.getBoolean(C0238R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0238R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0238R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0238R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0238R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0238R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0238R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02854());
        }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0238R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0238R.dimen.abc_dropdownitem_text_padding_left) : 0;
