...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C03601 implements StyleExtractor<FontInfo> {
        C03601() {
        }
    ...
    class C03612 implements StyleExtractor<FontFileResourceEntry> {
        C03612() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C03601());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C03612());
    }
