...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01102();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01091();
    ...
    class C01102 implements OnItemClickListener {
        C01102() {
        }
