...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01581();
    ...
    static class C01581 implements Creator<PlaybackStateCompat> {
        C01581() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01591();
        ...
        static class C01591 implements Creator<CustomAction> {
            C01591() {
            }
