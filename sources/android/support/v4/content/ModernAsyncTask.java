...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01121();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C03592();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01121 implements ThreadFactory {
    ...
    class C03592 extends WorkerRunnable<Params, Result> {
        C03592() {
        }
