...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02211();
    ...
    private final Runnable mSetIdleRunnable = new C02222();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02211 implements Interpolator {
        C02211() {
        }
