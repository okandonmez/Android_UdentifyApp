...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C01785();
    ...
    static class C01785 implements Comparator<byte[]> {
        C01785() {
        }
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest request, @NonNull final FontRequestCallback callback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C01703 implements Runnable {
                C01703() {
                }
            ...
            class C01714 implements Runnable {
                C01714() {
                }
            ...
            class C01725 implements Runnable {
                C01725() {
                }
            ...
            class C01736 implements Runnable {
                C01736() {
                }
            ...
            class C01758 implements Runnable {
                C01758() {
                }
                ...
                try {
                    ...
                    if (result.getStatusCode() != 0) {
                        switch (result.getStatusCode()) {
                            case 1:
                                callerThreadHandler.post(new C01692());
                                return;
                            case 2:
                                callerThreadHandler.post(new C01703());
                                return;
                            default:
                                callerThreadHandler.post(new C01714());
                                return;
                        }
                    }
                    FontInfo[] fonts = result.getFonts();
                    if (fonts == null || fonts.length == 0) {
                        callerThreadHandler.post(new C01725());
                        return;
                    }
                    for (FontInfo font : fonts) {
                        if (font.getResultCode() != 0) {
                            ...
                            if (resultCode < 0) {
                                callerThreadHandler.post(new C01736());
                                return;
                            } else {
                    ...
                    if (typeface == null) {
                        callerThreadHandler.post(new C01758());
                    } else {
                        callerThreadHandler.post(new Runnable() {
                            public void run() {
                    ...
                    callerThreadHandler.post(new C01681());
                }
            }
        });
    }
