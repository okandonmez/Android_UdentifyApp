...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C01862();
    public static final AbsSavedState EMPTY_STATE = new C03781();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C01862 implements ClassLoaderCreator<AbsSavedState> {
        C01862() {
        }
    ...
    static class C03781 extends AbsSavedState {
        C03781() {
            super();
        }
    }
