...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01941();
    ...
    private static final Interpolator sInterpolator = new C01952();
    ...
    private final Runnable mEndScrollRunnable = new C01963();
    ...
    static class C01941 implements Comparator<ItemInfo> {
        C01941() {
        }
    ...
    static class C01952 implements Interpolator {
        C01952() {
        }
    ...
    class C01963 implements Runnable {
        C01963() {
        }
    ...
    class C03794 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C03794());
    }
